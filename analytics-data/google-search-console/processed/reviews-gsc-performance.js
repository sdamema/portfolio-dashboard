...
window.portfolioPerformanceData.reviews = {
  ...
  "title": "Review pages relative data trend",
  "source": {
  ...
  "chartFootnote": "Hover or tap the chart to inspect each date. Absolute numerical values cannot be shown publicly, so the lines show percentage variations against the May pre-revamp baseline.",
  "events": [
    {
      "type": "marker",
      "kind": "revamp",
